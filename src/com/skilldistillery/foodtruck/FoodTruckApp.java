...
public class FoodTruckApp {
	...
	public static void main(String[] args) {
		...
		//while loop runs until the user selects to quit
		while (menuLoop) {
			System.out.println("========================================");
			...
			case 3:
				...
				//i use a string to track the highest rated, since truck name is a string, replacing the old 
					//highest rated truck if we find one rated higher
				//i use a highestRatedIndex variable to be able to print the truck to the console
				...
				for (int i = 0; i < foodTruckPark.length; i++) {
					FoodTruck currentTruck = foodTruckPark[i];
					if (currentTruck != null) {
						if (currentTruck.getRating() > highestRating) {
							highestRated = currentTruck.getName();
							highestRatedIndex = i;
						}
					}
				}
				System.out.println("The highest rated food truck is " + highestRated + ". All info printed below.");
